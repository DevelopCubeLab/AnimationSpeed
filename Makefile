...
after-package::
	...
	@mv ./packages/com.developlab.animationspeed_$(BUILD_VERSION).ipa ./packages/com.developlab.animationspeed_$(BUILD_VERSION).tipa || @echo -e "\033[31mNo .ipa file found.\033[0m"
	@echo -e "\033[1;32m\n** Build Succeeded **\n\033[0m"
